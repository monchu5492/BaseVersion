...
export const fetchPlayerName = () => function (dispatch) {
  ...
  return fetch(`${apiPath}/players/username`, {
    ...
    .then(fetchedPlayerName =>
      dispatch(actionCreators.requestPlayerNameSuccess(fetchedPlayerName))).catch((error) => {
      console.error(error);
...
export const fetchOwnerTournaments = () => function (dispatch) {
  ...
  return fetch(`${apiPath}/invited/owner`, {
    ...
    .then(fetchedOwner =>
      dispatch(actionCreators.requestOwnerTournamentsSuccess(fetchedOwner))).catch((error) => {
      console.error(error);
...
export const fetchTime = () => function (dispatch) {
  ...
  return fetch(`${apiPath}/games/servertime`, {
    ...
    .then(fetchedTime =>
      dispatch(actionCreators.requestTimeSuccess(fetchedTime))).catch((error) => {
      console.error(error);
...
export const setMessage = message => function (dispatch) {
...
export const checkForVideo = () => function (dispatch) {
  ...
  return fetch(`${apiPath}/adaptation/checkvideo`, {
    ...
    .then(videoStatus =>
      dispatch(actionCreators.checkVideoSuccess(videoStatus))).catch((error) => {
      console.error(error);
      dispatch(actionCreators.checkVideoError(error));
    });
};

export const fetchTournaments = () => function (dispatch) {
  ...
  return fetch(`${apiPath}/games/joinedtournaments`, {
    ...
    .then(fetchedTournaments =>
      dispatch(actionCreators.requestTournamentsSuccess(fetchedTournaments))).catch((error) => {
      console.error(error);
...
export const resetPassword = (token, password) => function (dispatch) {
  ...
  return fetch(`${apiPath}/reset_v2/${token}/${password}`, {
    ...
    .then(changedPassword =>
      dispatch(actionCreators.requestMessageSuccess(changedPassword))).catch((error) => {
      console.error(error);
...
export const forgotPassword = email => function (dispatch) {
  dispatch(actionCreators.checkEmail());
  ...
  return fetch(`${apiPath}/forgot_v2/${email}`, {
    ...
    .then(fetchedEmail =>
      dispatch(actionCreators.requestMessageSuccess(fetchedEmail))).catch((error) => {
      console.error(error);
      dispatch(actionCreators.requestMessageError(error));
    })
    .catch((err) => {
...
export const checkAuth = () => function (dispatch) {
  ...
  return fetch(`${apiPath}/noauth`, {
    ...
    .then(fetchedAuth =>
      dispatch(actionCreators.requestMessageSuccess(fetchedAuth))).catch((error) => {
      if (error) {
        console.error(error);
        dispatch(actionCreators.requestMessageError(error));
      }
